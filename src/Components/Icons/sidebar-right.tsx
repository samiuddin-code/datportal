...
export const SideBarRight = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      <path
        fill="#137749"
        d="M15.28 2v20h.91c.2 0 .4-.01.59-.02V2.03c-.19-.02-.39-.03-.59-.03h-.91zM9.03 15.309c.19 0 .38-.07.53-.22l2.56-2.56c.29-.29.29-.77 0-1.06l-2.56-2.56a.754.754 0 00-1.06 0c-.29.29-.29.77 0 1.06l2.02 2.03-2.02 2.03c-.29.29-.29.77 0 1.06.14.15.33.22.53.22z"
      ></path>
    </svg>
  );
};