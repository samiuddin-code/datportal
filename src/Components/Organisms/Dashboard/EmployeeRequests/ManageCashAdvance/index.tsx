...
import { CashAdvanceDrawer } from "@organisms/Dashboard/MyServices/CashAdvance/CashAdvanceDrawer";
import { CashAdvanceCard } from "@organisms/Dashboard/MyServices/CashAdvance/card";
...
const ManageCashAdvance = () => {
  ...
  const { data, onRefresh, setData, loading, meta } = useFetchData<CashAdvanceType[]>({
        ...
        filters={<div style={{ marginTop: '1.5rem' }}>
          ...
          <div >
            <CustomFilter
              ...
              name="status"
              withSearch={false}
              options={Object.entries(CashAdvanceStatus).map(([key, value]) => {
                return {
...
export default ManageCashAdvance;