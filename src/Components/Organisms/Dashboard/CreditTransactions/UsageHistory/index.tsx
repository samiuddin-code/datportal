...
const CreditsUsageHistory = () => {
	...
	const onSelected = (event: any) => {
		...
		if (name === "userId" || name === "propertyId") {
	...
	}, [selectedFilters, organizationModule]);
					...
					<div className={styles.filterWrapper}>
						...
						<div>
							<CustomFilter
								...
								label="User ID"
								name="userId"
								value={String(selectedFilters?.userId)}
								onChange={onSelected}
								onReset={() => {
									setReset(true)
						...
						<div>
							<CustomFilter
								...
								label="Property ID"
								name="propertyId"
								value={String(selectedFilters?.propertyId)}
								onChange={onSelected}
								onReset={() => {
									setReset(true)
...
export default CreditsUsageHistory;
